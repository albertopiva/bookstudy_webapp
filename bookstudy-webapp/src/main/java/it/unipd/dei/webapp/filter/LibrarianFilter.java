...
/**
 * Filter to manage the Librarian protected resources.
 *
 * @author BookStudy Group
 * @version 1.0
 * @since 1.0
 */
public class LibrarianFilter extends AbstractFilter{

    /**
     * Get the logger resource.
     */
    static Logger logger = LogManager.getLogger(LibrarianFilter.class);
    ...
    public void doFilter(HttpServletRequest req, HttpServletResponse res, FilterChain chain)
        ...
        if (loggedIn) {
            if (session.getAttribute("role").equals("librarian")) {
