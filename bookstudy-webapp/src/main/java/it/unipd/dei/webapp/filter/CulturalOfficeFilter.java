...
/**
 * Filter to manage the Cultural Office protected resources.
 *
 * @author BookStudy Group
 * @version 1.0
 * @since 1.0
 */
public class CulturalOfficeFilter extends AbstractFilter{

    /**
     * Get the logger resource.
     */
    static Logger logger = LogManager.getLogger(CulturalOfficeFilter.class);
    ...
    public void doFilter(HttpServletRequest req, HttpServletResponse res, FilterChain chain)
        ...
        if (loggedIn) {
            if (session.getAttribute("role").equals("cultural_office")) {
