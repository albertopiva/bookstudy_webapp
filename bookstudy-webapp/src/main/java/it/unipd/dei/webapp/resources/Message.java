...
/**
 * Represents a message or a personal error message that is not present in the list of error code.
 * 
...
public class Message extends Resource {
	...
	/**
	 * Write a {@code Message} object in a JSON format.
	 * @param out the stream to which the JSON representation of the {@code Message} has to be written.
	 *
