...
/**
 * Filter to manage the Organizer protected resources.
 *
 * @author BookStudy Group
 * @version 1.0
 * @since 1.0
 */
public class OrganizerFilter extends AbstractFilter{

    /**
     * Get the logger resource.
     */
    static Logger logger = LogManager.getLogger(OrganizerFilter.class);
