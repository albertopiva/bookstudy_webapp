...
/**
 * Filter to manage the Admin protected resources.
 *
 * @author BookStudy Group
 * @version 1.0
 * @since 1.0
 */
public class AdminAssFilter extends AbstractFilter{

    /**
     * Get the logger resource.
     */
    static Logger logger = LogManager.getLogger(AdminAssFilter.class);
